...
def test_raise_error_on_too_old_api_version(api):
    ...
    msg = "Unsupported api version ({}), use newest version ({}) by updating rtbhouse_sdk package.".format(
...
def test_raises_warning_on_not_the_newest_api_version(api):
    ...
    msg = "Used api version ({}) is outdated, use newest version ({}) by updating " "rtbhouse_sdk package.".format(
        API_VERSION, newest_version
    )
